package com.hardik.pomfrey.security.utility;
...
import com.hardik.pomfrey.security.configuration.properties.JwtConfiguration;
...
public class JwtUtils {
	...
	public String generateToken(User user) {
		...
		claims.put("contact_number", user.getContactNumber());
